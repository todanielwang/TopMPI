...
def main():
    ...
    for input_file in input_files:
        ...
        merge.main([new_sub_dir, filterbyFeature, keepDecoys, "-t", args.spectrum_cutoff_type, "-v", str(args.spectrum_cutoff_value), 
                    "-T", args.proteoform_cutoff_type, "-V", str(args.proteoform_cutoff_value), "-p", str(args.proteoform_error_tolerance)])
